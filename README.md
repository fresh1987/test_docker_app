Тестовые сценарии напианы и протестированы с Python 2.7.13 + Windows 10.
Резульаты прогонки тестов в файлах log.html, output.xml, report.html.


ТЗ для разработки тестовых сценариев:
# Установка окружения
Для запуска необходимо приложение [Docker](https://docs.docker.com/engine/installation/) с утилитой Docker-Compose.



Fresh: !!! проследить чтобы в BIOS была включена вирутализация!
